...
void solve() {
  ...
  pr1:
	...
	if (i < lhc) rl.append(1,'u');//lhc-1 u's
	if (i >= lhc && i < CROSSL[lhc]-rhc) rl.append(1,((i-lhc)/A)%2 == 0?'o':'u');
	if (i >= CROSSL[lhc]-rhc) rl.append(1,'u');//rhc-1 u's
      }
  ...
  pl2:
	...
	if (i < rhc+1) rl.append(1,'u');//rhc u's
	if (i >= rhc+1 && i < CROSSR[rhc]-lhc-1) rl.append(1,((i-rhc-1)/A)%2 == 0?'o':'u');
	if (i >= CROSSR[rhc]-lhc-1) rl.append(1,'u');//lhc u's
      }
